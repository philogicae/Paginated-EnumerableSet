...
/**
 * @title PaginatedEnumerableSet
 * @author @philogicae
 * @notice Modified version of EnumerableSet library with pagination.
 *
 * Original docs:
 ...
 * ====
 */
library PaginatedEnumerableSet {
    ...
    /**
     * @dev Returns a subset of values, allowing paginated calls in case the set is too large.
     *
     * Note that there are no guarantees on the ordering of values inside the
     * array, and it may change when more values are added or removed.
     * Meant to be used only in view functions
     *
     * Requirements:
     *
